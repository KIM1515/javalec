...
public class _03_method {
	...
	public static void main(String[] args) {
		...
		//그러면 메소드의 결과값(return 값)이 해당변수에 저장
		...
		//void형태는 반환타입이 없기 때문에 메소드 내에서 미리 선언해 놓은
		//전역변수나 static변수에 결과에 값을 담아줘야 한다.
		add(5, 6, 7);
	...
	//곱하기 메소드 만들기(메소드명: multiple, 반환타입은 long(매개변수 2개), void(매개변수3개)
